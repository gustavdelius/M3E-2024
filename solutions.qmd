...
### Fishing model with diffusion {.unnumbered}
@exr-fish
...
c. We know from part a. that $\partial_{\tilde t}u=\partial_t I/(\beta K^2)$. Thus we now want $D_1\partial_x^2 S/(\beta K^2)=\partial_{\tilde{x}}^2 u$, where $u=S/K$. Hence
$$
