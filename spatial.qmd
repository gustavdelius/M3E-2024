...
![Sketch of the marine protected area](figures/Spatial/mpa.svg){width=70%}

We now want to determine the minimum width of the river to ensure the fish population does not collapse. We first determine the spatially uniform steady states and indicate their stability. The steady states are given by the solutions of
